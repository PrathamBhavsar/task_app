...
class AppColors {
  ...
  static MaterialColor createMaterialColor(Color color) {
    Map<int, Color> colorShades = {
      50: Color.alphaBlend(Colors.white.withValues(alpha: 0.9), color),
      100: Color.alphaBlend(Colors.white.withValues(alpha: 0.8), color),
      200: Color.alphaBlend(Colors.white.withValues(alpha: 0.6), color),
      300: Color.alphaBlend(Colors.white.withValues(alpha: 0.4), color),
      400: Color.alphaBlend(Colors.white.withValues(alpha: 0.2), color),
      500: color,
      600: Color.alphaBlend(Colors.black.withValues(alpha: 0.1), color),
      700: Color.alphaBlend(Colors.black.withValues(alpha: 0.2), color),
      800: Color.alphaBlend(Colors.black.withValues(alpha: 0.3), color),
      900: Color.alphaBlend(Colors.black.withValues(alpha: 0.4), color),
    };
