          ...
          child: BorderedContainer(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Go with it',
                  style: AppTexts.inputHintTextStyle.copyWith(fontSize: 16.sp),
                ),
                10.hGap,
                Text(
                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              Text('Admin', style: AppTexts.inputTextStyle),
                            ],
                          ),
                          Row(
                            children: [
                              ...
                              Text('Salesperson', style: AppTexts.inputTextStyle),
                            ],
                          ),
                          Row(
                            children: [
                              ...
                              Text('Agency', style: AppTexts.inputTextStyle),
                            ],
                          ),
                        ],
                      ),
                ...
                ActionButton(
                  ...
                  onPress: () => context.pushReplacement('home'),
                ),
              ],
            ),
