...
import '../../../../../../../utils/extensions/indian_format.dart';
                          ...
                          children: [
                            ...
                            ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return Row(
                                  ...
                                  children: [
                                    Text(cost.name),
                                    Text(cost.rate.toIndianFormat()),
                                    Text(cost.qty.toIndianFormat()),
                                    Text(cost.total.toIndianFormat()),
                                  ],
                                );
                              },
                            ),
                            Row(
                              ...
                              children: [
                                ...
                                Text(
                                  provider.totalAdditionalCost.toIndianFormat(),
                                  style: TextStyle(
                                      fontSize: 20,
                                      fontWeight: FontWeight.w800),
                                ),
