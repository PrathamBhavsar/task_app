...
import '../../blocs/priority/priority_bloc.dart';
import '../../blocs/priority/priority_event.dart';
import '../../blocs/priority/priority_state.dart';
import '../../blocs/status/status_bloc.dart';
import '../../blocs/status/status_event.dart';
import '../../blocs/status/status_state.dart';
...
class _SplashScreenState extends State<SplashScreen> {
  ...
  // final Completer<void> _statusesLoaded = Completer();
  // final Completer<void> _prioritiesLoaded = Completer();
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      // context.read<StatusBloc>().add(FetchStatusesRequested());
      // context.read<PriorityBloc>().add(FetchPrioritiesRequested());
      ...
      try {
        ...
        // await _statusesLoaded.future;
        // await _prioritiesLoaded.future;
    ...
    return Scaffold(
      body: MultiBlocListener(
        listeners: [
          ...
          //       if (!_statusesLoaded.isCompleted) {
          //         _statusesLoaded.complete();
          //       }
          //     } else if (state is StatusLoadFailure) {
          //       _statusesLoaded.completeError('Status failed');
          //     }
          //   },
          // ),
          // BlocListener<PriorityBloc, PriorityState>(
          //   listener: (context, state) {
          //     if (state is PriorityLoadSuccess) {
          //       if (!_prioritiesLoaded.isCompleted) {
          //         _prioritiesLoaded.complete();
          //       }
          //     } else if (state is PriorityLoadFailure) {
          //       _prioritiesLoaded.completeError('Priority failed');
          //     }
          //   },
          // ),
